...
def numNegativos(numero):
     if numero<0:
          print("El número es un número negativo con lo cuál no es valido, por favor digita un número correcto ")
          return False
     else:
          return True  
...
while numNegativos(DiasLaborados)==False:
     DiasLaborados=int(input("Días laborados: "))
